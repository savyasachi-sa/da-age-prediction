...
class DatasetDesign():
    def __init__(self, src, ethnicity, source_val_split_perc):
        self.img_location = src
        ...
        with open('/Users/vulcan/da-age-prediction/Data/source_train.csv', 'w', newline='') as file:
        ...
        with open('/Users/vulcan/da-age-prediction/Data/source_validation.csv', 'w', newline='') as file:
            writer = csv.writer(file)
            writer.writerow(fieldnames)
        ...
        with open('/Users/vulcan/da-age-prediction/Data/target_train.csv', 'w', newline='') as file:
            writer = csv.writer(file)
            writer.writerow(fieldnames)
